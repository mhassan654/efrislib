...
class GlobalInfo implements JsonSerializable
{
    ...
    public function __construct(
        ...
        public ExtendField $extendField = new ExtendField()
    ) {
    ...
    {
        return [
            'tin' => $this->tin, 'deviceNo' => $this->deviceNo, 'interfaceCode' => $this->interfaceCode,
    ...
    public static function fromJson(array $jsonData): self
    {
        return new self(
            $jsonData['tin'],
            $jsonData['deviceNo'],
            $jsonData['interfaceCode'],
            $jsonData['brn'],
            $jsonData['appId'],
            $jsonData['version'],
            $jsonData['dataExchangeId'],
            $jsonData['requestTime'],
            $jsonData['requestCode'],
            ...
            $jsonData['longitude'],
            $jsonData['latitude'],
            ExtendField::fromJson($jsonData['extendField'])
        );
    }
}
